        ...
        if foundWeapon == 0 then
            ...
            if observedTraceTemplate.DisplayName == "h08bf2cfeg4d3eg4f8agac64g5622cd9d5551" then
                ...
                elseif weaponSlot[1] ~= nil and weaponSlot[2] ~= nil then
                    ...
                    local extraSpellNum = addExtraDescription(character,weaponSlot, weaponUUID, meleeOrRanged, weaponTemplates)
                ...
                table.insert(localTraceTable,traceObject:new(displayName, wielderIcon,
                weaponUUID,spellProperties, observedTraceTemplate.UseCosts, tooltipApply,
                wielderStrength, wielderDexterity, wielderMovementSpeed,meleeOrRanged))
...
function addExtraDescription(character, weaponSlot, weaponUUID, meleeOrRanged, weaponTemplates)
